...
(function(app) {
    ...
    var _alert = {
        ...
        show: function(key, options) {
            ...
            if (!!options.autoClose) this._setAutoCloseTimer(alert, options.onAutoClose);
         ...
         * @private
         */
        _setAutoCloseTimer: function(alert, onAutoClose) {
            ...
            }, this), app.config.alertAutoCloseDelay || 9000);
        },
