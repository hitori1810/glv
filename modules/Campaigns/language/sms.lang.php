...
$mod_strings = array (
  ...
  'LBL_NEWSLETTER_TITLE'=>'Campaigns: SMS',
  'LBL_SEARCH_FORM_TITLE' => 'Campaign Search',
  'LBL_LIST_FORM_TITLE' => 'Campaign List',
  'LBL_NEWSLETTER_LIST_FORM_TITLE' => 'SMS List',
  ...
  'LNK_PROSPECT_LIST_LIST' => 'Marketing List',
  ...
  'LBL_EMAIL_CAMPAIGNS_TITLE' =>'SMS Campaigns',
  ...
  'LBL_EMAIL_MARKETING_SUBPANEL_TITLE' => 'SMS Marketing',
  'LNK_NEW_EMAIL_TEMPLATE' => 'Create SMS Template',
  'LNK_EMAIL_TEMPLATE_LIST' => 'SMS Templates',
  'LBL_TRACK_BUTTON_TITLE' =>'View Status',
  'LBL_TRACK_BUTTON_KEY' =>'T',
  'LBL_TRACK_BUTTON_LABEL' =>'View Status',
  'LBL_QUEUE_BUTTON_TITLE'=>'Send SMS',
  'LBL_QUEUE_BUTTON_KEY'=>'u',
  'LBL_QUEUE_BUTTON_LABEL'=>'Send SMS',
  ...
  'LBL_DEFAULT'=>'All Marketing List',
  ...
  'LBL_LOG_ENTRIES_INVALID_EMAIL_TITLE'=>'Bounced Messages,Invalid SMS',
  ...
  //error messages.
  'ERR_NO_EMAIL_MARKETING'=>'There must be at least one active SMS Marketing message associated with the campaign.',
  'ERR_NO_TARGET_LISTS'=>'There must be at least one Marketing List associated with the campaign.',
  'ERR_NO_TEST_TARGET_LISTS'=>'There must be at least one Marketing List of type Test associated with the campaign.',
  'ERR_SENDING_NOW'=>'Messages are being delivered , please try this later.',
  'ERR_MESS_NOT_FOUND_FOR_LIST'=>'No SMS Marketing message found for this target list',
  'ERR_MESS_DUPLICATE_FOR_LIST'=>'Multiple SMS Marketing messages are defined for this target list',
  ...
  'LBL_NEWSLETTERS'=>'SMS',
  'LBL_NEWSLETTER'=>'SMS',
  'LBL_NEWSLETTER_FORENTRY'=>'SMS',
  'LBL_MORE_DETAILS' => 'More Details',
  'LBL_CREATE_NEWSLETTER'=>'Create SMS',
  'LBL_LIST_NAME' => 'Name',
  ...
  'LBL_TEMPLATE' => 'Template: ', # tracy: from 'Email Template: ' to 'Template : ' to make it generic
  'LBL_CREATE_EMAIL_TEMPLATE'=> 'Create',
  'LBL_MESSAGE_FOR' => 'Send This Message To:',
  'LBL_FINISH' => 'Finish',
  'LBL_ALL_PROSPECT_LISTS'=>'All Marketing List(s) in the Campaign.',
  'LBL_EDIT_EMAIL_TEMPLATE'=>   'Edit',
  'LBL_EMAIL_SETUP_WIZARD'=>   'SMS Setup',
  'LBL_DIAGNOSTIC_WIZARD'=>   'Diagnostics',
  'LBL_ALREADY_SUBSCRIBED_HEADER'=>'SMS Subscribed To',
  'LBL_UNSUBSCRIBED_HEADER'=>'Available/SMS Unsubscribed To',
  'LBL_UNSUBSCRIBED_HEADER_EXPL'=>'Moving the SMS to the Available SMS/SMSs Unsubscribed To list will add the contact to the Unsubscription List for this SMS.  It will not remove the contact from the original Subscription List or Target List.', 
  ...
  'LBL_WIZARD_SUBSCRIPTION_MESSAGE' => 'Each SMS must have three target lists (Subscription, Unsubscription, and Test). You can assign an existing target list. If not, an empty target list will be created when you save the SMS.',
  'LBL_WIZARD_TARGET_MESSAGE1' => 'Select or create a target list for use with your campaign.  This list will be used while sending SMS with your marketing messages.',
  ...
  'LBL_WIZARD_MARKETING_MESSAGE' => 'Fill out the form below to create an SMS instance for your SMS.  This will allow you to specify the information regarding when and how your SMS should be distributed.',
  'LBL_WIZARD_SENDMAIL_MESSAGE' => 'This is the last step in the process.  Select whether you wish to send out a test SMS, schedule your SMS for distribution, or save the changes and proceed to the summary page.',
  ...
  'LBL_WIZ_SMS_TITLE_STEP1' => 'Campaign Header',
  'LBL_WIZ_SMS_TITLE_STEP2' => 'Campaign Budget',
  'LBL_WIZ_SMS_TITLE_STEP3' => 'Campaign Tracker URLs ',
  'LBL_WIZ_SMS_TITLE_STEP4' => 'Subscription Information',
  'LBL_WIZ_MARKETING_TITLE' => 'Marketing ', # tracy: from 'Marketing Email ' to 'Marketing ' to make it generic
  'LBL_WIZ_SENDMAIL_TITLE' => 'Send SMS',
  'LBL_WIZ_SENDSMS_TITLE' => 'Send SMS', # tracy:
'LBL_WIZ_TEST_EMAIL_TITLE' => 'Test SMS',
  'LBL_WIZ_SMS_TITLE_SUMMARY' => 'Summary',
  ...
  'LBL_NAVIGATION_MENU_SEND_EMAIL' => 'Send SMS', 
  'LBL_NAVIGATION_MENU_SEND_SMS' => 'Send SMS',	# tracy:
  'LBL_NAVIGATION_MENU_SUBSCRIPTIONS' => 'Subscriptions',
  'LBL_NAVIGATION_MENU_SUMMARY' => 'Summary',
  'LBL_SUBSCRIPTION_TARGET_WIZARD_DESC' =>  'This will define the target list of type Subscription for this campaign.<br>  This target list will be used to send out SMS for this campaign.  <br>If you do not have a list ready, an empty list will be created for you.',
  'LBL_UNSUBSCRIPTION_TARGET_WIZARD_DESC' => 'This will define the target list of type Unsubscription for this campaign.  <br>This target list will contain names of people who have opted out of your campaign and should not be contacted through SMS.  <br>If you do not have a list ready, an empty list will be created for you.',
  'LBL_TEST_TARGET_WIZARD_DESC' => 'This will define the target list of type Test for this campaign.  <br>This target list will be used to send out test SMS for this campaign.  <br>If you do not have a list ready, an empty list will be created for you.',
  'LBL_TRACKERS' => 'Trackers',
  'LBL_ADD_TRACKER' => 'Create Tracker',
  'LBL_ADD_TARGET' => 'Add',
  'LBL_CREATE_TARGET'=> 'Create',
  'LBL_SELECT_TARGET'=> 'Use existing Marketing List',
  'LBL_REMOVE' => ' rem',
  'LBL_CONFIRM' => 'Start',
  'LBL_START' => 'Start',
  'LBL_TOTAL_ENTRIES' => 'Entries',
  'LBL_CONFIRM_CAMPAIGN_SAVE_CONTINUE' => 'Save work and proceed to Marketing SMS',
  ...
  'LBL_CONFIRM_SEND_SAVE' => 'You are about to leave and proceed to the Send Campaign SMS page.  Do you wish to save and continue?',
  'LBL_SMS WIZARD_TITLE' => 'SMS: ',
  'LBL_SMS_WIZARD_START_TITLE' => 'Edit SMS: ',
  'LBL_CAMPAIGN_WIZARD_START_TITLE' => 'Edit Campaign: ',
  'LBL_SEND_AS_TEST' => 'Send Marketing SMS As Test',
  'LBL_SAVE_EXIT_BUTTON_LABEL' => 'Finish',
  'LBL_SAVE_CONTINUE_BUTTON_LABEL' => 'Save and Continue',
  'LBL_TARGET_LISTS' => 'Marketing List',
  'LBL_NO_SUBS_ENTRIES_WARNING' => 'You cannot send a marketing SMS until your subscription list has at least one entry.  You can populate your list after finishing.',
  'LBL_NO_TARGET_ENTRIES_WARNING' => 'You cannot send a marketing SMS until your target list has at least one entry.  You can populate your list after finishing.',
  'LBL_NO_TARGETS_WARNING' => 'You cannot send a marketing SMS until your campaign has at least one target list.',
  'LBL_NONE' => 'none created',
  'LBL_CAMPAIGN_WIZARD' => 'Campaign Wizard',
  'LBL_EMAIL' =>'SMS',
  'LBL_OTHER_TYPE_CAMPAIGN' => 'Non-SMS based Campaign',
  'LBL_CHOOSE_CAMPAIGN_TYPE' => 'Campaign Type',
  'LBL_TARGET_LIST' => 'Marketing List',
  'LBL_TARGET_TYPE' => 'Marketing List Type',
  'LBL_TARGET_NAME' => 'Marketing List Name',
  'LBL_EMAILS_SCHEDULED' => 'SMS Scheduled',
  'LBL_TEST_EMAILS_SENT' => 'Test SMS Sent',
  'LBL_USERS_CANNOT_OPTOUT' => 'System User cannot opt out of receiving SMS.',
  'LBL_ELECTED_TO_OPTOUT' => 'You have elected to opt out of receiving SMS.',
  'LBL_COPY_OF' => 'Copy of ',
  'LBL_SAVED_SEARCH' => 'Saved Search & Layout',
  //email setup wizard
  'LBL_WIZ_FROM_NAME'                         => 'From Name:',
  'LBL_WIZ_FROM_ADDRESS'                      => 'From Address:',
  'LBL_EMAILS_PER_RUN'                        => 'Number of SMS sent per batch:',
  'LBL_CUSTOM_LOCATION'                       => 'User Defined',
  'LBL_DEFAULT_LOCATION'                      => 'Default ',
  'ERR_INT_ONLY_EMAIL_PER_RUN'                => 'Only integer values are allow for Number of SMS sent per batch',
  ...
  'LBL_EMAIL_SETUP_WIZARD_TITLE'              => 'SMS Setup for Campaigns',
  'TRACKING_ENTRIES_LOCATION_DEFAULT_VALUE'   => 'Value of Config.php setting site_url',
  'LBL_NOTIFY_TITLE'                          => 'SMS Notification Options',
  ...
  'LBL_NAVIGATION_MENU_SETUP'                 => 'Setup SMS',
  ...
  'LBL_CAMP_MESSAGE_COPY_DESC'                     => 'Would you like to store complete copies of <bold>EACH</bold> SMS message sent during all campaigns?  <bold>We recommend and default to no</bold>.  Choosing no will store only the template that is sent and the needed variables to recreate the individual message.',
  'LBL_YES'                                   => 'Yes',
  'LBL_NO'                                    => 'No',
  'LBL_FROM_ADDR'                             => '"From" Address',
  'LBL_DEFAULT_FROM_ADDR'                     => 'Default: ',
  'LBL_EMAIL_SETUP_DESC'                      => 'Fill out the form below to modify your system settings so that campaign SMS can be sent out.',
  'LBL_CREATE_MAILBOX'                        => 'Create New Mail Account',
  'LBL_SSL_DESC'                              => 'If your mail server supports secure socket connections, enabling this will force SSL connections when importing SMS.',
  'LBL_SSL'                                   => 'Use SSL',
  //campaign diagnostics
  'LNK_CAMPAIGN_DIGNOSTIC_LINK' => 'Campaign may not function as desired and your SMS may not be sent for the following reasons:',
  ...
  'LBL_MAILBOX_CHECK2_BAD'    => 'Please configure your system SMS address.  E-mail Settings have not been configured.',
  'LBL_SCHEDULER_CHECK_GOOD' => 'Schedulers detected',
  'LBL_SCHEDULER_CHECK_BAD' =>   'No Schedulers detected',
  'LBL_SCHEDULER_CHECK1_BAD'  => 'Scheduler has not been set up to process Bounced Campaign SMS.',
  'LBL_SCHEDULER_CHECK2_BAD'  => 'Scheduler has not been set up to process Campaign SMS.',
  'LBL_SCHEDULER_NAME' =>   'Scheduler',
  'LBL_SCHEDULER_STATUS' =>   'Status',
  'LBL_MARKETING_CHECK1_GOOD' => 'SMS marketing components detected.',
  'LBL_MARKETING_CHECK1_BAD'  => 'No SMS marketing components detected, you will need to create one to mail out a campaign.',
  ...
  'LBL_EMAIL_SETUP_WIZ' => 'Launch SMS Setup',
  ...
  'LBL_EDIT_TARGET_LIST' => 'Edit Marketing List',
  'LBL_SEND_EMAIL'  => 'Schedule SMS',
  'LBL_SEND_SMS' => 'Schedule SMS', # tracy:
  'LBL_USE_EXISTING'  => 'Use Existing',
  'LBL_CREATE_NEW_MARKETING_EMAIL' => 'Create New Marketing SMS',
  ...
  'LBL_EMAIL_COMPONENTS' => 'SMS Components',
  ...
  //web to lead wizard titles
    ...
    'LBL_NOT_VALID_EMAIL_ADDRESS' =>'Not a valid SMS address',
    ...
    'LBL_LOG_ENTRIES_BLOCKEDD_TITLE'=>'Suppressed by SMS Address or domain',
    ...
    'LBL_EMAILMARKETING_SUBPANEL_TITLE' => 'SMS Marketing',
    ...
    'LBL_INVALID EMAIL_SUBPANEL_TITLE' => 'Invalid SMS',
