...
global $app_strings;
global $app_list_strings; // Add by Bui Kim Tung
global $mod_strings;
...
// Edit by Bui Kim Tung - Hide email info if SMS type
$smsDisplayStyle = "";
if ($focus->type == "sms") $smsDisplayStyle = "style='display:none;'";                        
$xtpl->assign("DISPLAY_STYLE", $smsDisplayStyle);       
