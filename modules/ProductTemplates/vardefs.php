...
$dictionary['ProductTemplate'] = array('table' => 'product_templates',
    ...
    ,'fields' => array (
        ...
        */
        ...
        array (
            ...
            'len' => 100,
            'size' => '20',
            'options' => 'supplier_ProductTemplates_list',
            'studio' => 'visible',
            'dependency' => false,
        ),
        'status2' =>
        ...
        array (
         ...
         //Add Relationship Product Templates - Inventory detail
    ...
    'acls' => array(
        'SugarACLAdminOnly' => array('adminFor' => 'Products', 'allowUserRead' => true),
        'SugarACLStatic' => true,   // issue #309
