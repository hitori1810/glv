...
$module_menu = Array(
    ...
    //----------
    Array("index.php?module=ProductTemplates&action=EditView&return_module=ProductTemplates&return_action=DetailView", $mod_strings['LNK_NEW_PRODUCT']),
    Array("index.php?module=ProductTemplates&action=index&return_module=ProductTemplates&return_action=DetailView", $mod_strings['LNK_PRODUCT_LIST']),
    Array("index.php?module=ProductTypes&action=EditView&return_module=ProductTypes&return_action=DetailView", $mod_strings['LNK_NEW_PRODUCT_TYPE']),
	);
