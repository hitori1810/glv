 ...
 * subscribed to the UnifiedCRM Inc. product ("Company") that Company is bound by
 * the UnifiedCRM Inc. Master Subscription Agreement (“MSA”), which is viewable at:
 ...
 *
 * Copyright (C) 2004-2013 UnifiedCRM Inc.  All rights reserved.
 ********************************************************************************/
