...
//					}
	        ...
	        $runUpdate = false;
	        if($checkForUpdate){
                //$runUpdate = (!empty($this->_bean->id) && empty($this->_bean->new_with_id) && !empty($this->_bean->save_from_post)); //comment by tung Bui - fix bug save team set id by Msas update
	        	$runUpdate = (!empty($this->_bean->id) && empty($this->_bean->new_with_id)); 
	        }
