<?php
    ...
    ********************************************************************************/
    ...
    if ( SugarAutoLoader::existing('custom/include/images/sugar_md.png') ) {
        ...
        $login_image = '<IMG src="include/images/onlinecrm.png" alt="Sugar" width="340">';
    }
    ...
    if (isset($_COOKIE['authenticated_user_string_cookie']) && $_COOKIE['authenticated_user_string_cookie'] != '') {
