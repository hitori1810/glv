...
class UsersViewTemplatePopup extends ViewPopup
{
    /**
    * Override display function of Sugar
    * 
    * @author   Thuan Nguyen
    */
    public function display()
    {
        ...
        /**
        * Custom query in popup list view
        * 
        * @author   Thuan Nguyen
        */
        $popupMeta['whereStatement'] = ' users.is_template=1';
        //END: Custom query in popup list view
