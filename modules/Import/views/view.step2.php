    ...
    */
    public function display()
    {
        ...
        if($_REQUEST['import_module'] == 'Leads'){
            $download_url = 'custom/uploads/TemplateImport/Template_Import_Lead_'.$GLOBALS['current_language'].'.xlsx';
        ...
        switch($this->importModule){
            case "Leads":
                $defaultMappingRecord = $admin->settings['custom_default_mapping_lead'];
                break;
            case "C_Parent":
                $defaultMappingRecord = $admin->settings['custom_default_mapping_parent'];
                break;
        }
