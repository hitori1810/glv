...
if(empty($sugar_config['disc_client'])){
	if(ACLController::checkAccess('Quotes', 'list', true))$module_menu[] =Array("index.php?module=Reports&action=index&query=true&report_module=Quotes", $mod_strings['LNK_QUOTE_REPORTS'],"QuoteReports", 'Quotes');
}
