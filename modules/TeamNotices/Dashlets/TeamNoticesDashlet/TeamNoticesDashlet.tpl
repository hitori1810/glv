...
<tr>
<td colspan='1' valign='top' height='100px' class="teamNoticeBox">

<div id='daddydiv' style="position:relative;width=100%;height:90px;overflow:hidden" onmouseover="stopNotice();" onmouseout="startNotice();">
