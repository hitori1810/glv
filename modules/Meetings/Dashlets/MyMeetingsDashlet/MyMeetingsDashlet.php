...
class MyMeetingsDashlet extends DashletGeneric {
    ...
    function process($lvsParams = array()) {
        ...
        if($this->myItemsOnly) {
        	...
        	$lvsParams['custom_where'] = ' AND meetings.meeting_type <> \'Session\' AND (meetings.assigned_user_id = \'' . $current_user->id . '\' OR (m_u.user_id = \'' . $current_user->id . '\' AND m_u.deleted=0)) ';
        }
