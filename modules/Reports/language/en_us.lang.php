...
// report_name
  ...
  'LBL_GROUP_BY_REQUIRED'=>'At least one Group By and one Summary column are required to render a chart.<br>',
    ...
    'LBL_LIMIT_RESULT' => 'Limit Result',
    'LBL_CUSTOM_URL_HELP' => 'Included file executes before the report showed. <br>Directory : FILE_PATH/FILE_NAME.php',

    'LBL_EMBEDDED_REPORT_DESC' => 'Create a embedded report that displays additional data related to the records in the results.',
    'LBL_EMBEDDED_REPORT' => 'Embedded Report',

    'LBL_IFAME_REPORT_DESC' => 'Create a iframe report that displays iframe in the results.',
    'LBL_IFAME_REPORT' => 'Iframe Report',
