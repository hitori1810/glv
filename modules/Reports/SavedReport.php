...
class SavedReport extends SugarBean
{
    ...
    var $limit_result; // Add By Hai Nguyen
    ...
    function save_report($id, $owner_id, $name, $module,$report_type,$content,$is_published = 0,$team_id, $chart_type='none') {
        ...
        // save report Embedded & Iframe - Lap Nguyen
        ...
        $this->list_of =  implode(",",$_REQUEST['list_of']);
        //END
        // Save limit record - By Hai Duc
        $this->limit_result = $_REQUEST['limit_result'];
        //END By Hai Duc
