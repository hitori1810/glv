...
if(ACLController::checkAccess('Cases', 'list', true))$module_menu[] =Array("index.php?module=Reports&action=index&query=true&report_module=Cases", $mod_strings['LNK_CASE_REPORTS'],"CaseReports", 'Cases');
