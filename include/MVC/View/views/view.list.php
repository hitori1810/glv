...
class ViewList extends SugarView{
    ...
    function listViewPrepare(){
        ...
        $_SESSION[$GLOBALS['current_user']->user_name]['displayColumns'] = $this->lv->displayColumns;
    }
    ...
    function prepareSearchForm()
    {
        ...
        $view = 'advanced_search';  // Added by Hieu Nguyen on 2015-05-04 to make advanced search form as default
        $this->view = $view;
