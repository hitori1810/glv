...
function addModuleSelectFilter(cell, filter, row) {
    ...
    option_info['text'] = '<b>'+module_defs[current_module].label+'</b>'; //Add Bold label - Lap Nguyen
    ...
    for (var i in link_defs) {
        ...
        if (i != 'self') {
            label = label; //Remove Related Module - Lap Nguyen
        }
        option_info['text'] = '<b>'+label+'</b>'; //Add Bold label - Lap Nguyen
        option_info['selected'] = selected;
        options[options.length] = option_info;
        j = j + 1;
        if (selected) {
...
function newSelectSpanElement(name, inputTime) {
    ...
    // Fix core: remove time picker in select is between - By Lap Nguyen
    var text = '';
...
function addFilterInputSelectSingle(row, options, filter) {
    ...
    for (i = 0; i < options.length; i++) {
        ...
        if ((option_value == filter.input_name0) || (filter.name == 'user_name') && (filter.input_name0 == 'Current User') && (option_value == current_user_id)) {
            selected = true;
        } else {
            selected = false;
        }
...
function addFilterInputDatetimesBetween(row, filter) {
    ...
    div1.appendChild(this.newSelectSpanElement('namestart', '12:00am'));// Fix core: remove time picker in select is between - By Lap Nguyen
    ...
    div3.appendChild(this.newSelectSpanElement('nameend', '11:45pm'));// Fix core: remove time picker in select is between - By Lap Nguyen
    ...
    for (i = 0; i < info['options'].length; i++) {
        ...
        if(option['text'] != null && option['text'] != ''){
            ...
            if(n_err1 !== -1){
                ...
                var new_label = SUGAR.language.get(module_err, option['text'].substring(n_err1));
                ...
                if(n_err2 >= 0 && typeof module_err !== "undefined"){
                    option['text'] = option['text'].replace(module_err, SUGAR.language.get(module_err, 'LBL_MODULE_NAME'));
                }
            }
...
function showDuplicateOverlib(el, reportType, canCovertToMatrix) {
    if (reportType == 'tabular') {
        var menu = '<a style=\'width: 150px\' class=\'menuItem\' onmouseover=\'hiliteItem(this,"yes");\' ' + 'onmouseout=\'unhiliteItem(this);\' ' + 'onclick=\'document.EditView.to_pdf.value=\"\";document.EditView.to_csv.value=\"\";document.EditView.action.value=\"ReportsWizard\";document.EditView.save_as.value=\"true\";' + 'document.EditView.submit();\' href=\'#\'>' + SUGAR.language.get('Reports', 'LBL_DUPLICATE_AS_ORIGINAL') + '</a>' + '<a style=\'width: 150px\' class=\'menuItem\' onmouseover=\'hiliteItem(this,"yes");\' ' + 'onmouseout=\'unhiliteItem(this);\' ' + 'onclick=\'document.EditView.to_pdf.value=\"\";document.EditView.to_csv.value=\"\";document.EditView.action.value=\"ReportsWizard\";document.EditView.save_as.value=\"true\";' + 'document.EditView.save_as_report_type.value=\"summation\";document.EditView.submit();\' href=\'#\'>' + SUGAR.language.get('Reports', 'LBL_DUPLICATE_AS_SUMMATON') + '</a>' + '<a style=\'width: 150px\' class=\'menuItem\' onmouseover=\'hiliteItem(this,"yes");\' ' + 'onmouseout=\'unhiliteItem(this);\' ' + 'onclick=\'document.EditView.to_pdf.value=\"\";document.EditView.to_csv.value=\"\";document.EditView.action.value=\"ReportsWizard\";document.EditView.save_as.value=\"true\";' + 'document.EditView.save_as_report_type.value=\"summation_with_details\";document.EditView.submit();\' href=\'#\'>' + SUGAR.language.get('Reports', 'LBL_DUPLICATE_AS_SUMMATION_DETAILS') + '</a>' + '<a style=\'width: 150px\' class=\'menuItem\' onmouseover=\'hiliteItem(this,"yes");\' ' + 'onmouseout=\'unhiliteItem(this);\' ' + 'onclick=\'document.EditView.to_pdf.value=\"\";document.EditView.to_csv.value=\"\";document.EditView.action.value=\"ReportsWizard\";document.EditView.save_as.value=\"true\";' + 'document.EditView.save_as_report_type.value=\"matrix\";document.EditView.submit();\' href=\'#\'>' + SUGAR.language.get('Reports', 'LBL_DUPLICATE_AS_MATRIX') + '</a>';
    } else if (reportType == 'summation_with_details') {
        var menu = '<a style=\'width: 150px\' class=\'menuItem\' onmouseover=\'hiliteItem(this,"yes");\' ' + 'onmouseout=\'unhiliteItem(this);\' ' + 'onclick=\'document.EditView.to_pdf.value=\"\";document.EditView.to_csv.value=\"\";document.EditView.action.value=\"ReportsWizard\";document.EditView.save_as.value=\"true\";' + 'document.EditView.submit();\' href=\'#\'>' + SUGAR.language.get('Reports', 'LBL_DUPLICATE_AS_ORIGINAL') + '</a>' + '<a style=\'width: 150px\' class=\'menuItem\' onmouseover=\'hiliteItem(this,"yes");\' ' + 'onmouseout=\'unhiliteItem(this);\' ' + 'onclick=\'document.EditView.to_pdf.value=\"\";document.EditView.to_csv.value=\"\";document.EditView.action.value=\"ReportsWizard\";document.EditView.save_as.value=\"true\";' + 'document.EditView.save_as_report_type.value=\"summation\";document.EditView.submit();\' href=\'#\'>' + SUGAR.language.get('Reports', 'LBL_DUPLICATE_AS_SUMMATON') + '</a>' + '<a style=\'width: 150px\' class=\'menuItem\' onmouseover=\'hiliteItem(this,"yes");\' ' + 'onmouseout=\'unhiliteItem(this);\' ' + 'onclick=\'document.EditView.to_pdf.value=\"\";document.EditView.to_csv.value=\"\";document.EditView.action.value=\"ReportsWizard\";document.EditView.save_as.value=\"true\";' + 'document.EditView.save_as_report_type.value=\"tabular\";document.EditView.submit();\' href=\'#\'>' + SUGAR.language.get('Reports', 'LBL_DUPLICATE_AS_ROWS_AND_COLS') + '</a>';
        if (canCovertToMatrix) {
            menu += '<a style=\'width: 150px\' class=\'menuItem\' onmouseover=\'hiliteItem(this,"yes");\' ' + 'onmouseout=\'unhiliteItem(this);\' ' + 'onclick=\'document.EditView.to_pdf.value=\"\";document.EditView.to_csv.value=\"\";document.EditView.action.value=\"ReportsWizard\";document.EditView.save_as.value=\"true\";' + 'document.EditView.save_as_report_type.value=\"matrix\";document.EditView.submit();\' href=\'#\'>' + SUGAR.language.get('Reports', 'LBL_DUPLICATE_AS_MATRIX') + '</a>';
        }
