    ...
    return {
                ...
                if (report_def_str.summary_columns) {
                    ...
                    for (i = 0; i < report_def_str.summary_columns.length; i++) {
                        ...
                        for (var j = 0; j < report_def_str.group_defs.length; j++) {
                            if (report_def_str.group_defs[j].name == report_def_str.summary_columns[i].name && report_def_str.group_defs[j].table_key == report_def_str.summary_columns[i].table_key && typeof(report_def_str.summary_columns[i].group_function) == 'undefined') {
                                alreadyAdded = true;
                                break;
                            }
                        }
        ...
        saveDisplaySummaries: function() {
            ...
            for (var i = 1; i < table.rows.length; i++) {
                ...
                if (typeof(field_def.group_function) != 'undefined') {
                    ...
                    document.ReportsWizardForm.numerical_chart_column.options[document.ReportsWizardForm.numerical_chart_column.options.length] = new Option(field_def['label'], key);
        ...
        showWizardStepModuleSelect: function() {
            ...
            if (currWizardStep < 2) {
                ...
                if (report_type == 'tabular') {
                    document.getElementById('wizard_outline_div').innerHTML = SUGAR.language.get('Reports', 'LBL_ROWS_AND_COLUMNS_REPORT') + ' : ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'module_select\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_SELECT_MODULE') + '</a> > ' +
                    ...
                    document.getElementById('wizard_outline_div').innerHTML = reportTypeLabel + ' : ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'module_select\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_SELECT_MODULE') + '</a> > ' +
                        SUGAR.language.get('Reports', 'LBL_DEFINE_FILTERS') + ' > ' +
                    ...
                    document.getElementById('wizard_outline_div').innerHTML = SUGAR.language.get('Reports', 'LBL_SUMMATION_REPORT_WITH_DETAILS') + ' : ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'module_select\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_SELECT_MODULE') + '</a> > ' +
                        SUGAR.language.get('Reports', 'LBL_DEFINE_FILTERS') + ' > ' +
                        SUGAR.language.get('Reports', 'LBL_SELECT_GROUP_BY') + ' > ' +
                        SUGAR.language.get('Reports', 'LBL_DISPLAY_SUMMARIES') + ' > ' +
                        SUGAR.language.get('Reports', 'LBL_CHOOSE_DISPLAY_COLS') + ' > ' +
        ...
        showWizardStepFilters: function() {
            ...
            if (currWizardStep < 3) {
                currWizardStep++;
                if (report_type == 'tabular') {
                    document.getElementById('wizard_outline_div').innerHTML = SUGAR.language.get('Reports', 'LBL_ROWS_AND_COLUMNS_REPORT') + ' : ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'module_select\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_SELECT_MODULE') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'filters\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_DEFINE_FILTERS') + '</a> > ' +
                        SUGAR.language.get('Reports', 'LBL_CHOOSE_DISPLAY_COLS') + ' > ' +
                        SUGAR.language.get('Reports', 'LBL_REPORT_DETAILS') + '<br/><br/>';
                } else if (report_type == 'summation') {
                    var reportTypeLabel = SUGAR.language.get('Reports', 'LBL_SUMMATION_REPORT');
                    if (isMatrix)
                        reportTypeLabel = SUGAR.language.get('Reports', 'LBL_MATRIX_REPORT');
                    document.getElementById('wizard_outline_div').innerHTML = reportTypeLabel + ' : ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'module_select\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_SELECT_MODULE') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'filters\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_DEFINE_FILTERS') + '</a> > ' +
                        SUGAR.language.get('Reports', 'LBL_SELECT_GROUP_BY') + ' > ' +
                        SUGAR.language.get('Reports', 'LBL_DISPLAY_SUMMARIES') + ' > ' +
                        SUGAR.language.get('Reports', 'LBL_CHART_OPTIONS') + ' > ' +
                        SUGAR.language.get('Reports', 'LBL_REPORT_DETAILS') + '<br/><br/>';
                } else if (report_type == 'summation_with_details') {
                    document.getElementById('wizard_outline_div').innerHTML = SUGAR.language.get('Reports', 'LBL_SUMMATION_REPORT_WITH_DETAILS') + ' : ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'module_select\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_SELECT_MODULE') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'filters\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_DEFINE_FILTERS') + '</a> > ' +
                        SUGAR.language.get('Reports', 'LBL_SELECT_GROUP_BY') + ' > ' +
                        SUGAR.language.get('Reports', 'LBL_DISPLAY_SUMMARIES') + ' > ' +
                        SUGAR.language.get('Reports', 'LBL_CHOOSE_DISPLAY_COLS') + ' > ' +
                        SUGAR.language.get('Reports', 'LBL_CHART_OPTIONS') + ' > ' +
        ...
        showWizardStepDisplayColumns: function() {
            ...
            if (report_type == 'tabular' && currWizardStep < 4) {
                document.getElementById('wizard_outline_div').innerHTML = SUGAR.language.get('Reports', 'LBL_ROWS_AND_COLUMNS_REPORT') + ' : ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'module_select\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_SELECT_MODULE') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'filters\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_DEFINE_FILTERS') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'display\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_CHOOSE_DISPLAY_COLS') + '</a> > ' +
                    SUGAR.language.get('Reports', 'LBL_REPORT_DETAILS') + '<br/><br/>';
                currWizardStep++;
                SUGAR.reports.showDisplayColumnsPanel();
            } else if (report_type == 'summation_with_details' && currWizardStep < 6) {
                document.getElementById('wizard_outline_div').innerHTML = SUGAR.language.get('Reports', 'LBL_SUMMATION_REPORT_WITH_DETAILS') + ' : ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'module_select\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_SELECT_MODULE') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'filters\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_DEFINE_FILTERS') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'group_by\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_SELECT_GROUP_BY') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'display_summaries\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_DISPLAY_SUMMARIES') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'display\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_CHOOSE_DISPLAY_COLS') + '</a> > ' +
                    SUGAR.language.get('Reports', 'LBL_CHART_OPTIONS') + ' > ' +
                    SUGAR.language.get('Reports', 'LBL_REPORT_DETAILS') + '<br/><br/>';
                currWizardStep++;
                SUGAR.reports.showDisplayColumnsPanel();
        ...
        showWizardStepReportDetails: function() {
            ...
            currWizardStep++;
            if (report_type == 'tabular') {
                document.getElementById('wizard_outline_div').innerHTML = SUGAR.language.get('Reports', 'LBL_ROWS_AND_COLUMNS_REPORT') + ' : ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'module_select\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_SELECT_MODULE') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'filters\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_DEFINE_FILTERS') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'display\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_CHOOSE_DISPLAY_COLS') + '</a> > ' + '<b><a href="javascript:SUGAR.reports.showWizardStep(0,\'report_details\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_REPORT_DETAILS') + '</a></b><br/><br/>';
            } else if (report_type == 'summation') {
                var reportTypeLabel = SUGAR.language.get('Reports', 'LBL_SUMMATION_REPORT');
                if (isMatrix)
                    reportTypeLabel = SUGAR.language.get('Reports', 'LBL_MATRIX_REPORT');
                document.getElementById('wizard_outline_div').innerHTML = reportTypeLabel + ' : ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'module_select\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_SELECT_MODULE') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'filters\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_DEFINE_FILTERS') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'group_by\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_SELECT_GROUP_BY') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'display_summaries\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_DISPLAY_SUMMARIES') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'chart_options\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_CHART_OPTIONS') + '</a> > ' + '<b><a href="javascript:SUGAR.reports.showWizardStep(0,\'report_details\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_REPORT_DETAILS') + '</a></b><br/><br/>';
                ...
                document.getElementById('wizard_outline_div').innerHTML = SUGAR.language.get('Reports', 'LBL_SUMMATION_REPORT_WITH_DETAILS') + ' : ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'module_select\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_SELECT_MODULE') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'filters\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_DEFINE_FILTERS') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'group_by\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_SELECT_GROUP_BY') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'display_summaries\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_DISPLAY_SUMMARIES') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'display\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_CHOOSE_DISPLAY_COLS') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'chart_options\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_CHART_OPTIONS') + '</a> > ' + '<b><a href="javascript:SUGAR.reports.showWizardStep(0,\'report_details\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_REPORT_DETAILS') + '</a></b><br/><br/>';
            }
        ...
        showWizardStepGroupBy: function() {
            ...
            if (report_type == 'summation' && currWizardStep < 4) {
                ...
                if (isMatrix)
                    reportTypeLabel = SUGAR.language.get('Reports', 'LBL_MATRIX_REPORT');
                document.getElementById('wizard_outline_div').innerHTML = reportTypeLabel + ' : ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'module_select\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_SELECT_MODULE') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'filters\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_DEFINE_FILTERS') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'group_by\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_SELECT_GROUP_BY') + '</a> > ' +
                    SUGAR.language.get('Reports', 'LBL_DISPLAY_SUMMARIES') + ' > ' +
                    SUGAR.language.get('Reports', 'LBL_CHART_OPTIONS') + ' > ' +
                    SUGAR.language.get('Reports', 'LBL_REPORT_DETAILS') + '<br/><br/>';
                currWizardStep++;
        ...
        showWizardStepDisplaySummaries: function() {
            ...
            if (report_type == 'summation' && currWizardStep < 5) {
                ...
                if (isMatrix)
                    reportTypeLabel = SUGAR.language.get('Reports', 'LBL_MATRIX_REPORT');
                document.getElementById('wizard_outline_div').innerHTML = reportTypeLabel + ' : ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'module_select\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_SELECT_MODULE') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'filters\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_DEFINE_FILTERS') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'group_by\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_SELECT_GROUP_BY') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'display_summaries\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_DISPLAY_SUMMARIES') + '</a> > ' +
                    SUGAR.language.get('Reports', 'LBL_CHART_OPTIONS') + ' > ' +
                    SUGAR.language.get('Reports', 'LBL_REPORT_DETAILS') + '<br/><br/>';
                currWizardStep++;
        ...
        showWizardStepChartOptions: function() {
            ...
            if (report_type == 'summation' && currWizardStep < 6) {
                ...
                if (isMatrix)
                    reportTypeLabel = SUGAR.language.get('Reports', 'LBL_MATRIX_REPORT');
                document.getElementById('wizard_outline_div').innerHTML = reportTypeLabel + ' : ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'module_select\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_SELECT_MODULE') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'filters\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_DEFINE_FILTERS') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'group_by\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_SELECT_GROUP_BY') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'display_summaries\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_DISPLAY_SUMMARIES') + '</a> > ' + '<a href="javascript:SUGAR.reports.showWizardStep(0,\'chart_options\');" id="report_type_outline">' + SUGAR.language.get('Reports', 'LBL_CHART_OPTIONS') + '</a> > ' +
                    SUGAR.language.get('Reports', 'LBL_REPORT_DETAILS') + '<br/><br/>';
                currWizardStep++;
        ...
        orderBySelected: function(rowNum, sortDir) {
            ...
            directionSpan.innerHTML = '<select id="orderByDirection"><option value="a">' + SUGAR.language.get('Reports', 'LBL_ASCENDING') + '</option>' + '<option value="d">' + SUGAR.language.get('Reports', 'LBL_DESCENDING') + '</option></select>';
        ...
        summaryOrderBySelected: function(rowNum, sortDir) {
            ...
            directionSpan.innerHTML = '<select id="summaryOrderByDirection"><option value="a">' + SUGAR.language.get('Reports', 'LBL_ASCENDING') + '</option>' + '<option value="d">' + SUGAR.language.get('Reports', 'LBL_DESCENDING') + '</option></select>';
            if (typeof(sortDir) != 'undefined') {
                if (sortDir == 'a')
        ...
        addFieldToGroupBy: function(e) {
            ...
            cell.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;<input type='hidden' id='group_by_row_" + totalGroupByRows + "_module' value='" +
                record.getData('module_name') + "'>" + "<input type='hidden' id='group_by_row_" + totalGroupByRows + "_link' value='" +
                record.getData('parents_link') + "'>" + "<input type='hidden' id='group_by_row_" + totalGroupByRows + "_field' value='" +
        ...
        addFieldToDisplaySummaries: function(e, linkedGroupById) {
            ...
            cell.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;<input type='hidden' id='" + id + "_module' value='" +
                record.getData('module_name') + "'>" + "<input type='hidden' id='" + id + "_link' value='" +
                record.getData('parents_link') + "'>" + "<input type='hidden' id='" + id + "_field' value='" +
                record.getData('field_name') + "'>";
            var cell = row.insertCell(1);
            cell.setAttribute('scope', 'row');
            var colLabel = record.getData('parents') + " > " +
        ...
        addFieldToDisplayColumns: function(e) {
            ...
            cell.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;<input type='hidden' id='display_cols_row_" + totalDisplayColRows + "_module' value='" +
                record.getData('module_name') + "'>" + "<input type='hidden' id='display_cols_row_" + totalDisplayColRows + "_link' value='" +
                record.getData('parents_link') + "'>" + "<input type='hidden' id='display_cols_row_" + totalDisplayColRows + "_field' value='" +
                record.getData('field_name') + "'>";
            var cell = row.insertCell(1);
            cell.setAttribute('scope', 'row');
            var colLabel = record.getData('parents') + " > " +
        ...
        showGroupByColumns: function() {
            ...
            var panelHtml = "<table id='groupByTable' width='100%'><tr><td width='4%' class='dataLabel'>&nbsp;&nbsp;&nbsp;&nbsp;</td><td width='30%' class='dataLabel'><b>" + SUGAR.language.get('Reports', 'LBL_COLUMN_NAME') + "</td><td class='dataLabel'>&nbsp;</td></tr>" + "<tr id='group_by_help_row'><td>&nbsp;&nbsp;&nbsp;</td><td colspan=2><table width='70%' valign='center' class='button'><tr><td>" + SUGAR.language.get('Reports', 'LBL_GROUP_BY_HELP_DESC') + "</td></tr></table></td></tr></table>";
            ...
            var groupByModule = new YAHOO.widget.Module("group_by_div", {
                visible: false
            });
        ...
        showDisplaySummaries: function() {
            ...
            module = current_module;
            var panelHtml = "<table id='displaySummariesTable' width='100%'><tr><td width='4%' class='dataLabel'>&nbsp;&nbsp;&nbsp;&nbsp;</td><td width='30%' class='dataLabel'><b>" + SUGAR.language.get('Reports', 'LBL_COLUMN_NAME') + "</td><td class='dataLabel'>&nbsp;</td><td width='30%'><b>";
            if (report_type == 'summation')
                panelHtml += SUGAR.language.get('Reports', 'LBL_ORDER_BY') + "</b></td></tr>";
            panelHtml += "<tr id='display_summary_help_row'><td>&nbsp;&nbsp;&nbsp;</td><td colspan=2><table width='70%' valign='center' class='button'><tr><td>" + SUGAR.language.get('Reports', 'LBL_DISPLAY_SUMMARY_HELP_DESC') + "</td></tr></table></td></tr></table>";
            ...
            var displaySummariesModule = new YAHOO.widget.Module("display_summaries_div", {
                visible: false
            });
        ...
        showDisplayColumnsPanel: function() {
            ...
            module = current_module;
            var panelHtml = "<table id='displayColsTable' width='100%'><tr><th width='4%'>&nbsp;&nbsp;&nbsp;&nbsp;</th><th width='30%' scope='col'><b>" + SUGAR.language.get('Reports', 'LBL_COLUMN_NAME') + "</th><th width='30%' scope='col'><b>" + SUGAR.language.get('Reports', 'LBL_LABEL') + "</th>" + "<th width='30%' scope='col'><b>" + SUGAR.language.get('Reports', 'LBL_ORDER_BY') + "</th><th width='20%'></b>Merge<b></th><th></th></tr>" + "<tr id='display_cols_help_row'><td>&nbsp;&nbsp;&nbsp;</td><td colspan=3><table width='70%' valign='center' class='button'><tr><td>" + SUGAR.language.get('Reports', 'LBL_DISPLAY_COLS_HELP_DESC') + "</td></tr></table></td></tr></table>";
            ...
            var displayColsModule = new YAHOO.widget.Module("display_cols_div", {
                visible: false
            });
        ...
        deleteDisplaySummary: function(oTrigger) {
            ...
            SUGAR.reports.rebuildSummaryIndexes();
        },
        ...
        addFilterInputRelate: function(row, field, filter, isCustom) {
            ...
            new_input.onclick = function() {
                ...
                return open_popup(module_name, 600, 400, "", true, false, {
                    "call_back_function": "SUGAR.reports.set_form_return_reports",
                    "form_name": "ReportsWizardForm",
                    "field_to_name_array": {
                        "id": "id",
                        "name": "name"
                    }
        ...
        addFilterOnLoad: function(filter, current_filters_table) {
            ...
            filterCell.innerHTML = "<input type='hidden' id='" + current_filters_table + "_filter_row_" + totalFilterRows + "_field' value='" +
                filter.name + "'>" + "<input type='hidden' id='" + current_filters_table + "_filter_row_" + totalFilterRows + "_link' value='" +
                link + "'>" + "<input type='hidden' id='" + current_filters_table + "_filter_row_" + totalFilterRows + "_module' value='" +
                module + "'>";
            ...
            SUGAR.reports.addToFullTableList(current_filters_table + '_filter_row_' + totalFilterRows, parentsUIStrSoFar, link);
        ...
        addFieldToDisplayColumnsOnLoad: function(displayCol, orderBy) {
            ...
            cell.setAttribute('scope', 'row');
            cell.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;<input type='hidden' id='display_cols_row_" + totalDisplayColRows + "_module' value='" +
                module + "'>" + "<input type='hidden' id='display_cols_row_" + totalDisplayColRows + "_link' value='" +
                link + "'>" + "<input type='hidden' id='display_cols_row_" + totalDisplayColRows + "_field' value='" +
                fieldName + "'>";
            var cell = row.insertCell(1);
            cell.setAttribute('scope', 'row');
            if (typeof(field.vname) != "undefined")
            ...
            cell.setAttribute('scope', 'row');
            cell.innerHTML = "&nbsp;&nbsp;<img onclick='SUGAR.reports.deleteDisplayCol(\"display_cols_row_" + totalDisplayColRows + "\")' src='index.php?entryPoint=getImage&themeName=" + SUGAR.themes.theme_name + "&imageName=delete_inline.gif' alt='" + SUGAR.language.get("Reports", "LBL_REMOVE") + "'>";
            SUGAR.reports.addToFullTableList('display_cols_row_' + totalDisplayColRows, parentsUIStrSoFar, link);
            var dd11 = YAHOO.util.Dom.get('display_cols_row_' + totalDisplayColRows);
            dd11.dd = new SUGAR.reports.reportDDProxy('display_cols_row_' + totalDisplayColRows, 'group');
        },
        addFieldToGroupByOnLoad: function(groupByColumn, summaryOrderBy) {
            ...
            cell.setAttribute('scope', 'row');
            cell.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;<input type='hidden' id='group_by_row_" + totalGroupByRows + "_module' value='" +
                module + "'>" + "<input type='hidden' id='group_by_row_" + totalGroupByRows + "_link' value='" +
                link + "'>" + "<input type='hidden' id='group_by_row_" + totalGroupByRows + "_field' value='" +
                field.name + "'>";
            var cell = row.insertCell(1);
            cell.setAttribute('scope', 'row');
            if (typeof(field.vname) != "undefined")
            ...
            cell.innerHTML = colLabel;
            cell.setAttribute("onmouseover", "this.style.cursor = 'move'");
            SUGAR.reports.addToFullTableList('group_by_row_' + totalGroupByRows, parentsUIStrSoFar, link);
            cell = row.insertCell(2);
            cell.setAttribute('scope', 'row');
            cell.innerHTML = "&nbsp;&nbsp;<img onclick='SUGAR.reports.deleteGroupBy(\"group_by_row_" + totalGroupByRows + "\")' src='index.php?entryPoint=getImage&themeName=" + SUGAR.themes.theme_name + "&imageName=delete_inline.gif' alt='" + SUGAR.language.get("Reports", "LBL_REMOVE") + "'>";
            var dd11 = YAHOO.util.Dom.get(id);
        ...
        addFieldToDisplaySummariesOnLoad: function(summaryColumn, linkedGroupById, summaryOrderBy) {
            ...
            else if (summaryColumn.group_function && (summaryColumn.group_function == "weighted_amount" || summaryColumn.group_function == "weighted_sum"))
            ...
            if (typeof(summaryColumn.group_function) != 'undefined') {
                ...
                document.ReportsWizardForm.numerical_chart_column.options[document.ReportsWizardForm.numerical_chart_column.options.length] = new Option(summaryColumn.label, key);
            }
            var row = table.insertRow(table.rows.length);
            ...
            cell.setAttribute('scope', 'row');
            cell.innerHTML = "&nbsp;&nbsp;&nbsp;&nbsp;<input type='hidden' id='" + id + "_module' value='" +
                module + "'>" + "<input type='hidden' id='" + id + "_link' value='" +
                link + "'>" + "<input type='hidden' id='" + id + "_field' value='" +
                field.name + "'>";
            var cell = row.insertCell(1);
            cell.setAttribute('scope', 'row');
            if (typeof(field.vname) != "undefined")
            ...
            SUGAR.reports.addToFullTableList(id, parentsUIStrSoFar, link);
            var dd11 = YAHOO.util.Dom.get(id);
            dd11.dd = new SUGAR.reports.reportDDProxy(id, 'group_summaries');
        },
        copyFilter: function(origFilterRowId, origFilterRow, current_filters_table, filterDef) {
            ...
            var filterCell = filterRow.insertCell(0);
            filterCell.innerHTML = "<input type='hidden' id='" + current_filters_table + "_filter_row_" + totalFilterRows + "_field' value='" +
                document.getElementById(origFilterRowId + "_field").value + "'>" + "<input type='hidden' id='" + current_filters_table + "_filter_row_" + totalFilterRows + "_link' value='" +
                document.getElementById(origFilterRowId + "_link").value + "'>" + "<input type='hidden' id='" + current_filters_table + "_filter_row_" + totalFilterRows + "_module' value='" +
            ...
            SUGAR.reports.addToFullTableList(current_filters_table + '_filter_row_' + totalFilterRows, parents, document.getElementById(origFilterRowId + "_link").value);
            filters_arr[filters_arr.length] = new Object();
            filters_count++;
            filters_count_map[filters_count] = filters_arr.length - 1;
            current_filter_id = filters_count;
        ...
        addFieldToFilter: function(item, e) {
            ...
            var filterCell = filterRow.insertCell(0);
            filterCell.innerHTML = "<input type='hidden' id='" + current_filters_table + "_filter_row_" + totalFilterRows + "_field' value='" +
                fieldGridCell.getRecord(fieldGridCell.getSelectedRows()[0]).getData('field_name') + "'>" + "<input type='hidden' id='" + current_filters_table + "_filter_row_" + totalFilterRows + "_link' value='" +
                fieldGridCell.getRecord(fieldGridCell.getSelectedRows()[0]).getData('parents_link') + "'>" + "<input type='hidden' id='" + current_filters_table + "_filter_row_" + totalFilterRows + "_module' value='" +
            ...
            SUGAR.reports.addToFullTableList(current_filters_table + '_filter_row_' + totalFilterRows, fieldGridCell.getRecord(fieldGridCell.getSelectedRows()[0]).getData('parents'));
            filters_arr[filters_arr.length] = new Object();
            filters_count++;
            filters_count_map[filters_count] = filters_arr.length - 1;
            current_filter_id = filters_count;
        ...
        populateFieldGrid: function(module, link_name, parent_module, comboLabel) {
            ...
            var myColumnDefs = [{
                ...
                sortable: true,
                resizeable: false,
                label: SUGAR.language.get('Reports', 'LBL_FIELD_NAME'),
                abbr: '" scope="col'
            }];
            ...
            var myDataTable = new YAHOO.widget.ScrollingDataTable("module_fields", myColumnDefs, myDataSource, {
                height: "270px",
                width: "200px"
            });
        ...
        addFieldContextMenu: function(e, object) {
            ...
            myContextMenu = new YAHOO.widget.Menu("mycontextmenu", {
                'xy': YAHOO.util.Event.getXY(e.event),
                visible: true
            });
            ...
            for (var i = 0; i < panels.length; i++) {
                if (document.getElementById(panels[i].id + "_body_div") && panels[i].id != SUGAR.language.get('Reports', 'LBL_FILTER') + ".1") {
                    ...
                    var menuItem = new YAHOO.widget.MenuItem(panels[i].id, {
                        text: panels[i].id,
                        onclick: {
                            fn: SUGAR.reports.addFieldToFilterEvent,
                            obj: {
                                'item': item,
                                'e': object
                            }
        ...
        buildTree: function(module) {
            ...
            if (!moduleTree) {
                ...
                var moduleTree = new YAHOO.widget.Module("module_tree_panel", {
                    visible: false
                });
                ...
                moduleTree.render();
                moduleTree.show();
                var autocompletemodule = new YAHOO.widget.Module("autocomplete", {
                    visible: false
                });
                autocompletemodule.setHeader(title);
                autocompletemodule.render();
                autocompletemodule.show();
                var modulefields = new YAHOO.widget.Module("module_fields_panel", {
                    visible: false
                });
...
YAHOO.extend(SUGAR.reports.reportDDProxy, YAHOO.util.DDProxy, {
    ...
    onDragOver: function(e, targetId) {
        ...
        var dragEl = this.getDragEl();
        var el = this.getEl();
        if (this.lastTarget && this.lastTarget.id != 'displayColsTable' && this.lastTarget.id != 'displaySummariesTable' && this.lastTarget.id != 'groupByTable') {
