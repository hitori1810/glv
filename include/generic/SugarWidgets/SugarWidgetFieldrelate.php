...
class SugarWidgetFieldRelate extends SugarWidgetReportField
{
    ...
    //Function Added by Lap Nguyen - returns part of where in style table_alias.id NOT IN (...) because we can't join of relation
    public function queryFilternot_one_of($layout_def, $rename_columns = true)
    {
        ...
        $ids = array_unique($ids);
        return $this->_get_column_select($layout_def) . " NOT IN ('" . implode("', '", $ids) . "')";
    }
    //END
