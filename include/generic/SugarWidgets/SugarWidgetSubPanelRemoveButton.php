...
class SugarWidgetSubPanelRemoveButton extends SugarWidgetField
{
    ...
    function displayList(&$layout_def)
    {
        ...
        //Remove Unlink Logcall, Meeting, Tasks - By Lap Nguyen
        elseif( ($_REQUEST['module'] == 'Contacts' || $_REQUEST['module'] == 'Leads' || $_REQUEST['module'] == 'Prospects') && ($current_module == 'Calls' || $current_module == 'Tasks' || $current_module == 'Meetings')){
            $current_user_id = $GLOBALS['current_user']->id;
            if($current_user_id != $layout_def['fields']['ASSIGNED_USER_ID'] && $current_user_id != $layout_def['fields']['CREATED_BY'])
                $hideremove = true;
        }
