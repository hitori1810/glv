...
AH.ANIMATE=true;AH.AFTER_LOAD_COMPLETE=new YAHOO.util.CustomEvent("AFTER_LOAD_COMPLETE");AH.COLLECTIONS_MAP={};AH.VARIABLE_MAP={};AH.LISTENERS={};AH.LINKS={};AH.LOCKS={};AH.QUEUEDDEPS=[];AH.register=function(variable,view){if(!view)view=AH.lastView;if(typeof(AH.VARIABLE_MAP[view])=="undefined")
...
{if(field.className=="StringField"){return field.value;}
...
AH.getCollection=function(variable,view){if(!view)view=AH.lastView;var field=null;if(AH.COLLECTIONS_MAP[view]&&AH.COLLECTIONS_MAP[view][variable])
field=AH.COLLECTIONS_MAP[view][variable];return field;}
