...
<input type='hidden' name='query' value='true'/>
 ...
 <!-- Added by Hieu Nguyen on 2015-04-27 to save search form state -->
{php}
    if(isset($_POST['isShowMore'])) {
        $_SESSION['isShowMore'] = $_POST['isShowMore'];
        $this->assign('isShowMore', $_SESSION['isShowMore']);
    }
{/php}
<input type='hidden' id='isShowMore' name='isShowMore' value='{$isShowMore}'/>
<!-- End Hieu Nguyen -->
