<?php
    ...
    class C_FieldHighlighterViewEdit extends ViewEdit {

        function C_FieldHighlighterViewEdit() {
            parent::ViewEdit();
        }
        ...
        function display() {
            ...
            if(!empty($this->bean->target_module)) {
                ...
                if(count($appliedFields) > 0) {
                    foreach($appliedFields as $fieldName => $config) {
                        $appliedFieldArr[] = array(
                            ...
                            'applied_style' => $config->applied_style
                        );
                ...
                $fieldList = FieldHighlighterHelper::getFieldList($appliedModule);  
            ...
            $this->ss->assign('STYLE_OPTIONS', json_encode($app_list_strings['fieldhighlighter_style_options']));
