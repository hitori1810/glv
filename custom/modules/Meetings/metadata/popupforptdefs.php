<?php
//global $timedate;  
//$date_3 = $timedate->nowDb();
$popupMeta = array (
    'moduleMain' => 'Meetings',
    'varName' => 'Meeting',
    'orderBy' => 'meetings.name',
    //'whereStatement' => 'meetings.meeting_type = "Placement Test" AND meetings.date_start >= "'.$date_3.'"',
    'whereStatement' => 'meetings.meeting_type = "Placement Test" ',
    'whereClauses' => array (
        'name' => 'meetings.name',
