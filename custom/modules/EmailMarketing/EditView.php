...
$campaign->retrieve($focus->campaign_id);
...
if ($campaign->campaign_type == "SMS"){
    ...
    $validateScript = "removeFromValidate('EditView','from_name') ; removeFromValidate('EditView','from_addr');" ;
    $xtpl->assign("REMOVE_VALIDATE", $validateScript); 
} 
else{
    $xtpl->assign("HIDE_ELEMENT", "");  
    $xtpl->assign("REMOVE_VALIDATE", ''); 
}
//end Add By Hai Nguyen
...
if ($campaign->campaign_type == "SMS"){
    echo '<script type="text/javascript">';
        echo "removeFromValidate('EditView','from_name'); removeFromValidate('EditView','from_addr'); ";
    echo '</script>';
} 
