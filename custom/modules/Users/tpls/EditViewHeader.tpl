...
<!--Insert EditPicture plugin css by Thuan Nguyen-->
<link rel="stylesheet" type="text/css" href="{sugar_getjspath file='custom/include/javascripts/PictureEditor/PictureEditor.css'}">
<link rel="stylesheet" type="text/css" href="{sugar_getjspath file='custom/include/javascripts/PictureEditor/jquery.cropzoom.css'}">
<link rel="stylesheet" type="text/css" href="{sugar_getjspath file='custom/include/javascripts/PictureEditor/dhtmlxscheduler.css'}">
<!-- End -->
