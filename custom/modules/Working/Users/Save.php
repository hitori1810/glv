...
if(!$current_user->is_admin  && !is_admin_for_module($GLOBALS['current_user'],'Users')
	...
	// <abcona>
    // Extensions for Sugar-enjay Intgeration
    //
    if (isset($_REQUEST['enjay_call_notification_c']))
    {
       $focus->enjay_call_notification_c = 1;
    }
    else
    {
        $focus->enjay_call_notification_c = 0;
    }
    
    if (isset($_REQUEST['enjay_showclicktocall_c']))
    {
       $focus->enjay_showclicktocall_c = 1;
    }
    else
    {
        $focus->enjay_showclicktocall_c = 0;
    }
    if (isset($_REQUEST['enjay_relate_contact_c']))
    {
       $focus->enjay_relate_contact_c = 1;
    }
    else
    {
       $focus->enjay_relate_contact_c = 0;
    }
 
     if (isset($_REQUEST['enjay_relate_account_c']))
    {
       $focus->enjay_relate_account_c = 1;
    }
    else
    {
       $focus->enjay_relate_account_c = 0;
    }
    
    if (isset($_REQUEST['enjay_create_contact_c']))
    {
       $focus->enjay_create_contact_c = 1;
    }
    else
    {
       $focus->enjay_create_contact_c = 0;
    }
      if (isset($_REQUEST['enjay_create_account_c']))
    {
       $focus->enjay_create_account_c = 1;
    }
    else
    {
       $focus->enjay_create_account_c = 0;
    }
        if (isset($_REQUEST['enjay_create_lead_c']))
    {
       $focus->enjay_create_lead_c = 1;
    }
    else
    {
       $focus->enjay_create_lead_c = 0;
    }
    if (isset($_REQUEST['enjay_call_transfer_c']))
    {
       $focus->enjay_call_transfer_c = 1;
    }
    else
    {
       $focus->enjay_call_transfer_c = 0;
    }
    if (isset($_REQUEST['enjay_call_hangup_c']))
    {
       $focus->enjay_call_hangup_c = 1;
    }
    else
    {
       $focus->enjay_call_hangup_c = 0;
    }
    
     if (isset($_REQUEST['enjay_lastcall_c']))
    {
       $focus->enjay_lastcall_c = 1;
    }
    else
    {
       $focus->enjay_lastcall_c = 0;
    }
    
    
    
   if (isset($_REQUEST['enjay_phoneextension_c']))
    {
       $focus->enjay_phoneextension_c = $_REQUEST['enjay_phoneextension_c'];
    }
    else
    {
       $focus->enjay_phoneextension_c = '';
    }
    if (isset($_REQUEST['enjay_synapsename_c']))
    {
       $focus->enjay_synapsename_c = $_REQUEST['enjay_synapsename_c'];
    }
    else
    {
       $focus->enjay_synapsename_c = '';
    }
    if (isset($_REQUEST['enjay_dialout_prefix_c']))
    {
       $focus->enjay_dialout_prefix_c = $_REQUEST['enjay_dialout_prefix_c'];
    }
    else
    {
       $focus->enjay_dialout_prefix_c = '';
    }
    if (isset($_REQUEST['enjay_dial_plan_c']))
    {
       $focus->enjay_dial_plan_c = $_REQUEST['enjay_dial_plan_c'];
    }
    else
    {
       $focus->enjay_dial_plan_c = '';
    }
    // </abcona>
