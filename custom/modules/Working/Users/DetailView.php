...
{
    $xtpl->assign("ENJAY_RELATEACCOUNT_C", 'checked');
}
else
{
    $xtpl->assign("ENJAY_RELATEACCOUNT_C", '');
}

if ($focus->enjay_create_account_c)
{
    $xtpl->assign("ENJAY_CREATEACCOUNT_C", 'checked');
}
else
{
    $xtpl->assign("ENJAY_CREATEACCOUNT_C", '');
}

if ($focus->enjay_create_lead_c)
{
    $xtpl->assign("ENJAY_CREATELEAD_C", 'checked');
}
else
{
    $xtpl->assign("ENJAY_CREATELEAD_C", '');
}
if ($focus->enjay_create_contact_c)
{
    $xtpl->assign("ENJAY_CREATECONTACT_C", 'checked');
}
else
{
    $xtpl->assign("ENJAY_CREATECONTACT_C", '');
}

if ($focus->enjay_call_transfer_c)
{
    $xtpl->assign("ENJAY_CALLTRANSFER_C", 'checked');
}
else
{
    $xtpl->assign("ENJAY_CALLTRANSFER_C", '');
}

if ($focus->enjay_call_hangup_c)
{
    $xtpl->assign("ENJAY_CALLHANGUP_C", 'checked');
}
else
{
    $xtpl->assign("ENJAY_CALLHANGUP_C", '');
}
