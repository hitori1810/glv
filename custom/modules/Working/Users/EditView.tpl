...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="edit view">
	<tr>
		<th align="right" scope="row" class="dataLabel" colspan="3">
			<h4 >Enjay User Configuration</h4>
		</th>
	</tr>
	<tr>
        <td scope="row" width="17%"><slot>{$MOD.LBL_ENJAY_PHONEEXTENSION}</slot></td>
        <td width="15%" class="dataField"><slot><input type="text" tabindex='3' size='15' name="enjay_phoneextension_c" value="{$ENJAY_EXT_C}" size="3"></slot></td>
        
    </tr>
    <tr>
         <td scope="row" width="17%"><slot>{$MOD.LBL_ENJAY_SYNAPSE}</slot></td>
        <td width="15%" class="dataField"><slot><input type="text" tabindex='3' size='15' name="enjay_synapsename_c" value="{$ENJAY_HOST_C}" size="3"></slot></td>
               
   </tr>
   <tr>
         <td scope="row" width="17%"><slot>{$MOD.LBL_ENJAY_DIALOUTPREFIX}</slot></td>
        <td width="15%" class="dataField"><slot><input type="text" tabindex='3' size='15' name="enjay_dialout_prefix_c" value="{$ENJAY_DIALOUT_C}" size="3"></slot></td>
               
   </tr>
     <tr>
         <td scope="row" width="17%"><slot>{$MOD.LBL_ENJAY_DIALPLAN}</slot></td>
        <td width="15%" class="dataField"><slot><input type="text" tabindex='3' size='15' name="enjay_dial_plan_c" value="{$ENJAY_DIAL_PLAN_C}" size="3"></slot></td>
               
   </tr>
    
    <tr>
        <td scope="row" width="17%"><slot>{$MOD.LBL_ENJAY_CALL_NOTIFICATION}</slot></td>
		<td class="dataField"><slot><input type="checkbox" tabindex='3' name="enjay_call_notification_c" value="1" {$ENJAY_CALLNOTIFICATION_C}></slot></td>
    </tr>
    <tr>
        <td scope="row" width="17%"><slot>{$MOD.LBL_ENJAY_SHOWCLICKTOCALL}</slot></td>
		<td class="dataField"><slot><input type="checkbox" tabindex='3' name="enjay_showclicktocall_c" value="1" {$ENJAY_SHOWCLICKTOCALL_C}></slot></td>
		
    </tr>  
	<tr>
		<td scope="row" width="17%"><slot>{$MOD.LBL_ENJAY_RELATE_CONTACT}</slot></td>
		<td class="dataField"><slot><input type="checkbox" tabindex='3' name="enjay_relate_contact_c" value="1" {$ENJAY_RELATECONTACT_C}></slot></td>
	</tr>
	<tr>
		<td scope="row" width="17%"><slot>{$MOD.LBL_ENJAY_RELATE_ACCOUNT}</slot></td>
		<td class="dataField"><slot><input type="checkbox" tabindex='3' name="enjay_relate_account_c" value="1" {$ENJAY_RELATEACCOUNT_C}></slot></td>
		
	</tr>
	<tr>
		<td scope="row" width="17%"><slot>{$MOD.LBL_ENJAY_CREATE_CONTACT}</slot></td>
		<td class="dataField"><slot><input type="checkbox" tabindex='3' name="enjay_create_contact_c" value="1" {$ENJAY_CREATECONTACT_C}></slot></td>
	</tr>
	<tr>
		<td scope="row" width="17%"><slot>{$MOD.LBL_ENJAY_CREATE_ACCOUNT}</slot></td>
		<td class="dataField"><slot><input type="checkbox" tabindex='3' name="enjay_create_account_c" value="1" {$ENJAY_CREATEACCOUNT_C}></slot></td>
	</tr>
	<tr>
		<td scope="row" width="17%"><slot>{$MOD.LBL_ENJAY_CREATE_LEAD}</slot></td>
		<td class="dataField"><slot><input type="checkbox" tabindex='3' name="enjay_create_lead_c" value="1" {$ENJAY_CREATELEAD_C}></slot></td>
	</tr>
	<tr>
		<td scope="row" width="17%"><slot>{$MOD.LBL_ENJAY_CALLTRANSFER}</slot></td>
		<td class="dataField"><slot><input type="checkbox" tabindex='3' name="enjay_call_transfer_c" value="1" {$ENJAY_CALLTRANSFER_C}></slot></td>
	</tr>
	
	<tr>
		<td scope="row" width="17%"><slot>{$MOD.LBL_ENJAY_CALLHANGUP}</slot></td>
		<td class="dataField"><slot><input type="checkbox" tabindex='3' name="enjay_call_hangup_c" value="1" {$ENJAY_CALLHANGUP_C}></slot></td>
		
	</tr>
	<tr>
		<td scope="row" width="17%"><slot>{$MOD.LBL_ENJAY_LAST_CALL}</slot></td>
		<td class="dataField"><slot><input type="checkbox" tabindex='3' name="enjay_lastcall_c" value="1" {$ENJAY_LASTCALL_C}></slot></td>
