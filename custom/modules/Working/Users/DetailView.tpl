        ...
        <div id='enjay'>
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail view">
				<tr>
					...
					<h4 class="tabDetailViewDL">Enjay User Configuration</h4>
					</th>
				</tr>
				<tr>
					<td class="tabDetailViewDL" style="width: 15%">{$MOD.LBL_ENJAY_PHONEEXTENSION}</td>
					<td class="tabDetailViewDF" style="width: 15%">{$ENJAY_EXT_C}</td>
					
				</tr>	
				<tr>
					<td class="tabDetailViewDL" style="width: 15%">{$MOD.LBL_ENJAY_SYNAPSE}</td>
					<td class="tabDetailViewDF" style="width: 15%">{$ENJAY_HOST_C}</td>
					
				</tr>
				<tr>
					<td class="tabDetailViewDL" style="width: 15%">{$MOD.LBL_ENJAY_DIALOUTPREFIX}</td>
					<td class="tabDetailViewDF" style="width: 15%">{$ENJAY_DIALOUT_C}</td>
					
				</tr>
				<tr>
					<td class="tabDetailViewDL" style="width: 15%">{$MOD.LBL_ENJAY_DIALPLAN}</td>
					<td class="tabDetailViewDF" style="width: 15%">{$ENJAY_DIAL_PLAN_C}</td>
					
				</tr>
				<tr>
					<td class="tabDetailViewDL">{$MOD.LBL_ENJAY_CALL_NOTIFICATION}</td>
					<td class="tabDetailViewDF"><input class="checkbox" type="checkbox" disabled {$ENJAY_CALLNOTIFICATION_C}/></td>
					
				</tr>
				<tr>
					<td class="tabDetailViewDL">{$MOD.LBL_ENJAY_SHOWCLICKTOCALL}</td>
					<td class="tabDetailViewDF"><input class="checkbox" type="checkbox" disabled {$ENJAY_SHOWCLICKTOCALL_C}/></td>
					
				</tr>
				
				<tr>
					<td class="tabDetailViewDL">{$MOD.LBL_ENJAY_RELATE_CONTACT}</td>
					<td class="tabDetailViewDF"><input class="checkbox" type="checkbox" disabled {$ENJAY_RELATECONTACT_C}/></td>
					
				</tr>
				<tr>
					<td class="tabDetailViewDL">{$MOD.LBL_ENJAY_RELATE_ACCOUNT}</td>
					<td class="tabDetailViewDF"><input class="checkbox" type="checkbox" disabled {$ENJAY_RELATEACCOUNT_C}/></td>
					
				</tr>
				<tr>
					<td class="tabDetailViewDL">{$MOD.LBL_ENJAY_CREATE_CONTACT}</td>
					<td class="tabDetailViewDF"><input class="checkbox" type="checkbox" disabled {$ENJAY_CREATECONTACT_C}/></td>
					
				</tr>
				<tr>
					<td class="tabDetailViewDL">{$MOD.LBL_ENJAY_CREATE_ACCOUNT}</td>
					<td class="tabDetailViewDF"><input class="checkbox" type="checkbox" disabled {$ENJAY_CREATEACCOUNT_C}/></td>
					
				</tr>
				<tr>
					<td class="tabDetailViewDL">{$MOD.LBL_ENJAY_CREATE_LEAD}</td>
					<td class="tabDetailViewDF"><input class="checkbox" type="checkbox" disabled {$ENJAY_CREATELEAD_C}/></td>
					
				</tr>
				<tr>
					<td class="tabDetailViewDL">{$MOD.LBL_ENJAY_CALLTRANSFER}</td>
					<td class="tabDetailViewDF"><input class="checkbox" type="checkbox" disabled {$ENJAY_CALLTRANSFER_C}/></td>
					
				</tr>
				<tr>
					<td class="tabDetailViewDL">{$MOD.LBL_ENJAY_CALLHANGUP}</td>
					<td class="tabDetailViewDF"><input class="checkbox" type="checkbox" disabled {$ENJAY_CALLHANGUP_C}/></td>
					
				</tr>
				<tr>
					<td class="tabDetailViewDL">{$MOD.LBL_ENJAY_LAST_CALL}</td>
					<td class="tabDetailViewDF"><input class="checkbox" type="checkbox" disabled {$ENJAY_LASTCALL_C}/></td>
