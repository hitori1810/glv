...
!(function ($, window) {
    ...
    */
    AjaxBootstrapSelect.prototype.init = function () {
        ...
        this.selectpicker.$searchbox.on(this.options.bindEvent, function (e) {
            ...
            // Only search when press enter (keyCode = 13)
            if (e.keyCode != 13) {
                return;
            }
    ...
    */
    var AjaxBootstrapSelectRequest = function (plugin) {
        // Edit by Bui Kim Tung
        // Re-show result pannel when press enter
        plugin.selectpicker.$menu.show();
        var that = this;
    ...
    */
    $.fn.ajaxSelectPicker.locale['en-US'] = {
        ...
        */
        statusInitialized: 'Press Enter to Search',
