...
$(document).ready(function(){
    ...
    function generatePicker(){
        ...
        $('<span class="dateFormat" style="margin-left: 3px;"><img id="'+thisID+'_trigger" align="absmiddle" border="0" alt="Enter Date" src="custom/themes/Sugar/images/jscalendar.png"></span>').insertAfter($this);
