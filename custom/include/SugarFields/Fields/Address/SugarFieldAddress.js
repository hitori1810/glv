...
********************************************************************************/
//Edit by Tung Bui - 18/01/2017 - Fix performance about Google Map Api 
if(typeof GoogleMapApiLoaded === "undefined" ){
    $.ajax({
        async: false,
        url: "https://maps.googleapis.com/maps/api/js?key=AIzaSyA4KBF8VWai7Fs6aD05s88Jb9nbAN2j3AE&v=3.exp&signed_in=true&libraries=places",
        dataType: "script"
    }); 
    GoogleMapApiLoaded = true;
}

//END - Edit by Tung Bui - 18/01/2017 
...
SUGAR.util.doWhen("typeof google != 'undefined'", function(){
    var forms = $('form');
