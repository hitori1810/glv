...
<span id="{{$idName}}_old" style="display:{if !$showRemove}none;{/if}">
  <img src="custom/include/surveylogo_images/{{sugarvar key='value'}}" height="100px" class="tabDetailViewDFLink">
...
{if !$noChange}
<span id="{{$idName}}_new" class="survey-logo-selection" style="display:{if $showRemove}none;{/if}">
...
{{else}}
    maxlength="255"
{{/if}}
{{$displayParams.field}}>&nbsp;&nbsp;<img title="The max upload image size should be 300px." src="themes/default/images/helpInline.gif?v=9F2a81TErGINGVZgMbDjow">
