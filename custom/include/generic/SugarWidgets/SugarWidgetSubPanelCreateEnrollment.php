...
class SugarWidgetSubPanelCreateEnrollment extends SugarWidgetSubPanelTopButton
{
    var $module;
    var $title;
    var $access_key;
    ...
    */
    function SugarWidgetSubPanelCreateEnrollment($module='', $title='', $access_key='', $form_value='')
    {
        global $app_strings;
    ...
    function display($defines, $additionalFormFields = null) {
        ...
        if ($GLOBALS['current_user']->team_type == 'Junior'){
            $onclick = "window.open('index.php?module=J_Payment&action=EditView&return_module=J_Payment&return_action=DetailView&payment_type=Enrollment&student_id=".$defines['focus']->id."','_blank')";
            $button = "<input type='button' class='button' onclick=\"{$onclick}\" value='".translate('LBL_CREATE_ENROLLMENT','J_Payment')."'>";
