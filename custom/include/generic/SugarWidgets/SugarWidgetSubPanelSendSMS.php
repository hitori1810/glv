...
class SugarWidgetSubPanelSendSMS extends SugarWidgetSubPanelTopButton
{
    var $module;
    var $title;
    var $access_key;
    ...
    */
    function SugarWidgetSubPanelSendSMS($module='', $title='', $access_key='', $form_value='')
    {
        global $app_strings;
    ...
    function display($defines, $additionalFormFields = null) {
        ...
        $button = "";
        if($currentModule == 'J_Class'){
            $onclick = "handleSendSMS();";
            $button = "<input type='button' class='button' onclick=\"{$onclick}\" value='".translate('LBL_SEND_SMS','J_Class')."'>";
        }
        return $button;
    }
