...
class SugarWidgetSubPanelCreatePayment extends SugarWidgetSubPanelTopButton
{
    var $module;
    var $title;
    var $access_key;
    ...
    */
    function SugarWidgetSubPanelCreatePayment($module='', $title='', $access_key='', $form_value='')
    {
        global $app_strings;
    ...
    function display($defines, $additionalFormFields = null) {
        ...
        if($currentModule == 'Leads'){
            $onclick = "window.open('index.php?module=J_Payment&action=EditView&return_module=J_Payment&return_action=DetailView&payment_type=Deposit&lead_id=".$defines['focus']->id."','_blank')";
            $button = "<input type='button' class='button' onclick=\"{$onclick}\" value='".translate('LNK_NEW_RECORD','J_Payment')."'>";
        }else{
            $onclick = "window.open('index.php?module=J_Payment&action=EditView&return_module=J_Payment&return_action=DetailView&payment_type=Cashholder&student_id=".$defines['focus']->id."','_blank')";
            $button = "<input type='button' class='button' onclick=\"{$onclick}\" value='".translate('LNK_NEW_RECORD','J_Payment')."'>";
        }
        return $button;
    }
